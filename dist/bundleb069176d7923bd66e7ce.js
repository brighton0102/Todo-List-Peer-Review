...
Object(function webpackMissingModule() { var e = new Error("Cannot find module './modules/genenerate_function.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
addButton.addEventListener('click', () => {
  ...
  if (addList.value !== '') {
    ...
    items.push(Object(function webpackMissingModule() { var e = new Error("Cannot find module './modules/genenerate_function.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(itemDescription, items.length));
    createItems(items);
    localStorage.setItem('toDoList', JSON.stringify(items));
    addList.value = '';
  }
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  container.addEventListener('click', (event) => {
    ...
    removeIcons.forEach((icon, index) => {
      if (event.target === icon) {
        Object(function webpackMissingModule() { var e = new Error("Cannot find module './modules/genenerate_function.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(items, index);
  ...
  document.getElementById('clear-btn').addEventListener('click', () => {
    Object(function webpackMissingModule() { var e = new Error("Cannot find module './modules/genenerate_function.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(items);
  });
});
...
/******/ })()
;
//# sourceMappingURL=bundleb069176d7923bd66e7ce.js.map